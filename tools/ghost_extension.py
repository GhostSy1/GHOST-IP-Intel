...
TOOL = "GHOST-IP-Intel"
VERSION = "3.0-PRO"
PROFILE = "Authorized asset and network intelligence investigator"
RULES = [('IP-IDENTITY', 'IPv4|IPv6|ASN|WHOIS|reverse DNS|PTR'), ('IP-SERVICE', 'open port|service|banner|protocol'), ('IP-SCOPE', 'authorized|allowlist|scope|target')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-IP-Intel v3.0-PRO (Zero-Guessing Engine)
\"\"\"
    print(banner)
